<?php namespace App\Http\Controllers;
	...
	class AdminActivitesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "activites";
			$this->limit = "20";
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Titre","name"=>"titre","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
